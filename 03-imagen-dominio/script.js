const texts = [
  ...
  "Frente a lo perenne del museo",
  "el arte contemporáneo toma consciencia",
  "del carácter provisional de su existencia.",
  "",
  "La imagen mimética y eterna ofrecida por el museo",
  "se agota",
  "",
  "el arte contemporáneo habita las imágenes virtuales contenidas en la realidad",
