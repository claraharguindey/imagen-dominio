const phrases = [
  ...
  "de seguir transmitiendo la fuerza y el poder","que el edificio quiso representar.",
  "",
  "En 1796, tres años después de la inauguración del Museo del Louvre,",
  "el pintor francés Hubert Robert dibuja una vista imaginaria de la Gran Galería del Museo",
  "en ruinas. ",
  "Como la ruina calculada de Speer,",
  "el museo se entiende a partir de su propia ruina",
...
const images = [
  ...
  "./../assets/images/hubert-robert/image8.png",
